...
-- Δευ 16 Ιαν 2023 11:17:37 πμ EET
...
VALUES
    (2, 'Άνθρωποι Μηχανές', 'Καισαριανή', 'Εθνικής Αντιστάσεως', 1),
    (4, 'Φροντιστήρια ΕΑΜ', 'Καισαριανή', 'Εθνικής Αντιστάσεως', 2);
...
VALUES
    (1, 'Web Developer', 'Πληροφορική', 'ΕΚΠΑ', '2023-12-25', 'Αθήνα', 6, 'Πλήρης Απασχόλησης', 0, 600,
     'Η εταιρεία μας εξειδικεύεται στον τομέα της Πληροφορικής για περισσότερα από 10 χρόνια! Κάθε χρόνο προτιμάται από τουλάχιστον 5 φοιτητές ΕΚΠΑ.', 1, 2, null),
    (2, 'IT Support', 'Πληροφορική', 'Όλα τα πανεπιστήμια', '2023-11-24', 'Αθήνα', 3, 'Μερικής Απασχόλησης', 1, 250,
    ...
    (3, 'Data Engineer', 'Πληροφορική', 'ΕΚΠΑ', '2023-12-25', 'Αθήνα', 6, 'Πλήρης Απασχόλησης', 0, 600,
     'Η εταιρείας μας προσφέρει θέση πρακτικής για φοιτητές ΕΚΠΑ που ενδιαφέρονται για τον τομέα της Πληροφορικής και πιο συγκεκριμένα για τον κλάδο των δεδομένων και προσφέρει πολλές δυνατότητες εξέλιξης!', 1, 2, null),
    (4, 'Βοηθός Λογιστή', 'Οικονομικά', 'Όλα τα πανεπιστήμια', '2023-11-04', 'Αθήνα', 3, 'Μερικής Απασχόλησης', 1, 250,
     'Η εταιρεία μας ψάχνει τελειόφοιτους φοιτητές για να τους καθοδηγήσει στον τομέα των Οικονομικών!', 1, 4, null);
